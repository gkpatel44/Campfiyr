...
class ProductCardBlack extends Component {
  state = {
    videoPlaying: false,
  };
  render() {debugger
    ...
    const { item ,productDb} = this.props;
...
ProductCardBlack.propTypes = {
  children: PropTypes.node,
  item: PropTypes.object.isRequired,
  // productDb:PropTypes.object.isRequired
  //   classes: PropTypes.any.isRequired,
};

function mapStateToProps(state) {
  return {
    userData: state.product.productDB,
  };
}

export default withStyles(styles)(connect(mapStateToProps)(ProductCardBlack));
